...
module fnd_controller (
    ...
    input 
    input [23:0] fnd_in_data_sw_w, //sw, w data : fnd_in_data에서 변경 
    ...
    // wire [3:0] w_dist_dist_100 = dist_9bit / 100;
...
// =======================================
    ...
    digit_splitter #(
        ...
        .in_data (fnd_in_data_sw_w[31:24]),
    ...
    digit_splitter #(
        ...
        .in_data (fnd_in_data_sw_w[23:16]),
...
// =======================================    
    ...
    digit_splitter #(
        ...
        .in_data (fnd_in_data_sw_w[23:19]),
    ...
    digit_splitter #(
        ...
        .in_data (fnd_in_data_sw_w[18:13]),
    ...
    digit_splitter #(
        ...
        .in_data (fnd_in_data_sw_w[6:0]),
        .digit_1 (w_digit_msec_1),
        .digit_10(w_digit_msec_10)
    );

    dot_onoff_comp U_DOT_COMP (
        .msec(fnd_in_data_sw_w[6:0]),
