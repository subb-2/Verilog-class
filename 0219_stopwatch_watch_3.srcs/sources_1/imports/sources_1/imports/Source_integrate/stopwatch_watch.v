...
module stopwatch_watch (
    ...
    wire [15:0] w_humidity_data, w_temperature_data;
...
// ===================================================
// Stopwatch datapath, watch datapath, SR04, DHT11
// ===================================================
    ...
    dht11_top U_DHT11_TOP (
        ...
        .humidity(w_humidity_data),
        .temperature(w_temperature_data),
        .dht_done(dht_done),
        .dht_valid(dht_valid),
...
// ===================================================
    ...
    mux_2x1_stopwatch_watch U_MUX_2x1_STOPWATCH_WATCH (
        ...
        .i_sel0_stopwatch(w_stopwatch_time),
        .i_sel1_watch(w_watch_time),
        .o_mux_sw_w_data(o_mux_sw_w_data)
    );
    ...
    fnd_controller U_FND_CNTL (
        ...
        .sel_set_4(w_sel_set_4),
        .fnd_in_data_sw_w (o_mux_sw_w_data),
        .fnd_digit  (fnd_digit),
        .fnd_data   (fnd_data)
    );
...
module mux_2x1_stopwatch_watch (
    ...
    output [23:0] o_mux_sw_w_data
);
    //sel 1 : output i_sel1 , 0 : i_sel0
    assign o_mux_sw_w_data = (sel_set) ? i_sel1_watch : i_sel0_stopwatch;
